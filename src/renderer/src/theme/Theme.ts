...
const theme = {
  ...
  inlineNotification: {
    ...
    iconStyle: {
      info: 'h-4 w-4 text-indigo-700 dark:text-indigo-200',
      error: 'h-4 w-4 text-rose-700 dark:text-rose-200',
      warning: 'h-4 w-4 text-amber-700 dark:text-amber-200',
      success: 'h-4 w-4 text-green-700 dark:text-green-200',
    },
    childrenText: {
