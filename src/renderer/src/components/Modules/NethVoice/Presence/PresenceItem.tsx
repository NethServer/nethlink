...
export function PresenceItem({
  ...
  return (
    <>
      ...
      <div className={`flex flex-col gap-1 w-full px-4 py-2 text-bgDark dark:text-bgLight hover:bg-hoverLight hover:dark:bg-hoverDark ${hasTopBar ? 'mt-3' : ''}`} onClick={handleClick}>
