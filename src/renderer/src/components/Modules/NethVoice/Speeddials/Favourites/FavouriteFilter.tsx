          ...
          <div className='flex gap-3 items-center'>
            <FontAwesomeIcon
              className={classNames(
                speeddialsModule?.favouriteOrder === type ? '' : 'invisible',
                'text-base dark:text-titleDark text-titleLight min-w-5',
              )}
              icon={CheckedIcon}
            />
        ...
        <div>
          <Menu>
            <div>
              <Menu.Button
                className={classNames(
                  'flex gap-2 justify-center min-w-8 min-h-8  dark:hover:bg-transparent hover:bg-transparent px-1',
            ...
            <Menu.Items
              className={
                'absolute border dark:border-borderDark border-borderLight rounded-lg min-w-[180px] min-h-[84px] dark:bg-bgDark bg-bgLight translate-x-[calc(-100%+36px)] z-[110]'
              }
            >
