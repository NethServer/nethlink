    ...
    <div className='px-5'>
      <div
        className={ClassNames(
          'flex justify-between items-center pb-1 border border-t-0 border-r-0 border-l-0 dark:border-borderDark border-borderLight h-[28px]',
          className,
        )}
      >
        {title && (
          ...
          >
            {title}
            {showTitleTooltip && (
              <CustomThemedTooltip id={tooltipId} place='bottom' />
            )}
          </h1>
        )}
        {action && (
