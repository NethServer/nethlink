...
export function SearchNumberBox({
  ...
  return (
    <div className="flex flex-col dark:text-titleDark text-titleLight dark:bg-bgDark bg-bgLight">
      <div
        className="flex gap-5 pt-[10px] pr-8 pb-[10px] pl-7 min-h-9 items-start dark:hover:bg-hoverDark hover:bg-hoverLight cursor-pointer"
      ...
      <div
        className="flex gap-5 pt-[10px] pr-8 pb-[10px] pl-7 w-full min-h-9 dark:hover:bg-hoverDark hover:bg-hoverLight cursor-pointer"
