  ...
  const router = createHashRouter([
    {
      ...
      element: (
        <Layout
          theme={parseThemeToClassName(theme)}
          page={pageData?.page as PAGES}
        />
      ),
      loader: loader,
      children: [
        {
          ...
          element: (
            <SplashScreenPage themeMode={parseThemeToClassName(theme)} />
          ),
        },
        {
          path: PAGES.LOGIN,
          element: (
            <LoginPage
              ...
              handleRefreshConnection={checkConnection}
            />
          ),
        },
        {
