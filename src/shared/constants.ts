...
export const GIT_RELEASES_URL =
  'https://api.github.com/repos/nethserver/nethlink/releases/latest'
...
export enum IPC_EVENTS {
  ...
  INTRUDE_CALL = 'INTRUDE_CALL',
  LISTEN_CALL = 'LISTEN_CALL',
  COMMAND_BAR_RESIZE = 'COMMAND_BAR_RESIZE',
}
